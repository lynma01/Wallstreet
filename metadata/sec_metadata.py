...
def return_filings(doc_to_append, appendee):
    doc_to_append = doc_to_append.__dict__
    del doc_to_append['element']
    appendee.append(doc_to_append)

def get_filing_metadata(name, cik, filing, no_filings) -> list:
    ...
    if no_filings == 1:
        ...
        for document in docs:
            return_filings(document, filings)
    return(filings)

print(get_filing_metadata("Oracle Corp", "0001341439", "10-K", 3))